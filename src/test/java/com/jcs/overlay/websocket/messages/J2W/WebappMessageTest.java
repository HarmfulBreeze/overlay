...
class WebappMessageTest {
    ...
    @Test
    void champSelectCreateMessageTest() {
        System.out.println("Starting champSelectCreateMessageTest...");
        TeamNames names = new TeamNames("Blue team", "Red team");
        ChampSelectCreateMessage.Color c1 = new ChampSelectCreateMessage.Color(0, 0, 0);
        ChampSelectCreateMessage.Color c2 = new ChampSelectCreateMessage.Color(255, 255, 255);
        ChampSelectCreateMessage.TeamColors colors = new ChampSelectCreateMessage.TeamColors(c1, c2);
        TimerStyle ts = TimerStyle.MOVING;
        Map<String, ChampSelectCreateMessage.Color> fc = new HashMap<>();
        fc.put("bans", new ChampSelectCreateMessage.Color(1, 1, 1));
        fc.put("picks", new ChampSelectCreateMessage.Color(2, 2, 2));
        fc.put("teamNames", new ChampSelectCreateMessage.Color(3, 3, 3));
        fc.put("timer", new ChampSelectCreateMessage.Color(4, 4, 4));
        ChampSelectCreateMessage.WebappConfig config = new ChampSelectCreateMessage.WebappConfig(true, "12", ts, fc);
        ChampSelectCreateMessage msg = new ChampSelectCreateMessage(names, colors, config);

        String expected = "{\"messageType\":\"ChampSelectCreate\",\"teamColors\":{\"team100Color\":{\"blue\":0,\"green\":0,\"red\":0},\"team200Color\":{\"blue\":255,\"green\":255,\"red\":255}},\"teamNames\":{\"team100\":\"Blue team\",\"team200\":\"Red team\"},\"webappConfig\":{\"championSplashesEnabled\":true,\"fontColors\":{\"timer\":{\"blue\":4,\"green\":4,\"red\":4},\"teamNames\":{\"blue\":3,\"green\":3,\"red\":3},\"picks\":{\"blue\":2,\"green\":2,\"red\":2},\"bans\":{\"blue\":1,\"green\":1,\"red\":1}},\"teamNamesFontSize\":\"12\",\"timerStyle\":\"moving\"}}";
        ...
        assertEquals(MOSHI.adapter(ChampSelectCreateMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
    ...
    @Test
    void champSelectDeleteMessageTest() {
        System.out.println("Starting champSelectDeleteMessageTest...");

        ChampSelectDeleteMessage msg = new ChampSelectDeleteMessage();
        String expected = "{\"messageType\":\"ChampSelectDelete\"}";
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(MOSHI.adapter(ChampSelectDeleteMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    void newBanMessageTest() {
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(MOSHI.adapter(NewBanMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    void playerNamesMessageTest() {
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(MOSHI.adapter(PlayerNamesMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    void preloadSplashImagesMessageTest() {
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(MOSHI.adapter(PreloadSplashImagesMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    void setBanIntentMessageTest() {
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(MOSHI.adapter(SetBanIntentMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    void setBanPickMessageTest() {
        ...
        assertEquals(MOSHI.adapter(SetBanPickMessage.class).toJson(msg1), expected1, "Generated message does not match the expected one!");
        assertEquals(MOSHI.adapter(SetBanPickMessage.class).toJson(msg2), expected2, "Generated message does not match the expected one!");
        assertEquals(MOSHI.adapter(SetBanPickMessage.class).toJson(msg3), expected3, "Generated message does not match the expected one!");
        assertEquals(MOSHI.adapter(SetBanPickMessage.class).toJson(msg4), expected4, "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    void setPickIntentMessageTest() {
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(MOSHI.adapter(SetPickIntentMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    void setSummonerSpellsMessageTest() {
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(MOSHI.adapter(SetSummonerSpellsMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    @Test
    void setTimerMessageTest() {
        System.out.println("Starting setTimerMessageTest...");
        long internalNow = System.currentTimeMillis();
        SetTimerMessage msg = new SetTimerMessage(internalNow, 154);
        String expected = "{\"adjustedTimeLeftInPhase\":154,\"internalNow\":" + internalNow + ",\"messageType\":\"SetTimer\"}";
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(MOSHI.adapter(SetTimerMessage.class).toJson(msg), expected, "Generated message does not match the expected one!");
        System.out.println("Passed.");
        
        System.out.println("Test setTimerMessageTest completed.");
    }
}