...
class WebappMessageTest {
    ...
    void champSelectCreateMessageTest() {
        ...
        assertEquals(expected, MOSHI.adapter(ChampSelectCreateMessage.class).toJson(msg), "Generated message does not match the expected one!");
    ...
    void champSelectDeleteMessageTest() {
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(expected, MOSHI.adapter(ChampSelectDeleteMessage.class).toJson(msg), "Generated message does not match the expected one!");
        System.out.println("Passed.");
    ...
    void setTimerMessageTest() {
        ...
        System.out.println("Comparing the JSON generated by Moshi to the expected one...");
        assertEquals(expected, MOSHI.adapter(SetTimerMessage.class).toJson(msg), "Generated message does not match the expected one!");
        System.out.println("Passed.");
